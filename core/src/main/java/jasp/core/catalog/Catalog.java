...
import jasp.core.db.DbSupport;
import jasp.core.db.Result;
import jasp.core.db.SQL;
...
public class Catalog extends DbSupport implements AutoCloseable {
    ...
    static final String SEQUENCE_ID = "jasp_id_seq";
    static final String TABLE_INFO = "jasp_info";
    static final String TABLE_OBJECT = "jasp_object";
    static final String TABLE_DATASET = "jasp_dataset";
    static final String TABLE_FOLDER = "jasp_folder";
    static final String TABLE_MAP = "jasp_map";
    static final String TABLE_TAG = "jasp_tag";
